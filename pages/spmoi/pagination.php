...
$record_per_page = 20;  
    ...
    $query = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tinhtrang=1 ORDER BY id_sanpham DESC LIMIT $start_from, $record_per_page";  
    ...
    $page_query = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tinhtrang=1 ORDER BY id_sanpham DESC";  
