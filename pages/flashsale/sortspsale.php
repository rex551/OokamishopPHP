...
if(isset($_POST['action'])){
    $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 LIMIT 40" ;
    
    if(($_POST['value']) == 'hotpro'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1  ORDER BY giasp desc LIMIT 40";
    }
    if(($_POST['value']) == 'priceasc'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1  ORDER BY giasp asc LIMIT 40";
    }
    if(($_POST['value']) == 'pricedesc'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 ORDER BY giasp desc LIMIT 40";
    }
    if(($_POST['value']) == 'az'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 ORDER BY tensanpham asc LIMIT 40";
    }
    if(($_POST['value']) == 'za'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 ORDER BY tensanpham desc LIMIT 40";
    }
    if(($_POST['value']) == 'oldpro'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 ORDER BY id_sanpham asc LIMIT 40";
    }
    if(($_POST['value']) == 'newpro'){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 ORDER BY id_sanpham desc LIMIT 40";
    }
    $output = '';
