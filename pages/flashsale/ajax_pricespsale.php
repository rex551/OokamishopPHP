...
if(isset($_POST["action"]))
{
    ...
    if(isset($_POST["price"]) && !empty($_POST["price"])){
        $sql = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND giamgia >0 AND tinhtrang=1 AND  giasp BETWEEN  0 AND '".$_POST["price"]."' LIMIT 40 ";
        $result = mysqli_query($mysqli,$sql);
    }
    $output = '';
