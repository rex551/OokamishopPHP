<?php  
    ...
    $query = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.giamgia > 0 AND tinhtrang=1 ORDER BY id_sanpham DESC LIMIT $start_from, $record_per_page";  
    ...
    $page_query = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.giamgia >0 AND tinhtrang=1 ORDER BY id_sanpham DESC";  
