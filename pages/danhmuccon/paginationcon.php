...
include('../../admincp/config/config.php');
    ...
    $query = "SELECT * FROM tbl_sanpham,tbl_danhmuccon WHERE tbl_sanpham.id_danhmuccon=tbl_danhmuccon.id_danhmuccon AND tinhtrang=1 AND tbl_sanpham.id_danhmuccon='".$_POST["id"]."' ORDER BY id_sanpham DESC LIMIT $start_from, $record_per_page";  
    ...
    $page_query = "SELECT * FROM tbl_sanpham,tbl_danhmuccon WHERE tbl_sanpham.id_danhmuccon=tbl_danhmuccon.id_danhmuccon AND tinhtrang=1 AND tbl_sanpham.id_danhmuccon='".$_POST["id"]."' ORDER BY id_sanpham DESC";  
