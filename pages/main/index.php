...
<?php
	$sql_proid = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tinhtrang=1 ORDER BY tbl_sanpham.id_sanpham DESC LIMIT 8 ";
	$query_proid = mysqli_query($mysqli,$sql_proid);

	include("pages/main/slidershow.php"); 
?>
<div class="container mt-5">
	<div class="row">
		<div class="col-md-12 text-center textnewpro"><h3 class="fontchubig"><b><a href="collections/san-pham-moi" style="text-decoration: none;">SẢN PHẨM MỚI</a></b></h3></div>
	</div>
</div>
<div class="container fontchuquicksand mt-5">
	<div class="row">
	<?php 
		while($row_pro= mysqli_fetch_array($query_proid)){
	?>
	...
	<div class="d-flex justify-content-center mt-5 fontchuquicksand">
		<button type="button" class="btn btnxemthem justify-content-center"><a class="non" href="collections/san-pham-moi"><b>Xem Thêm</b></a></button>
		</div>
</div>

<?php include("pages/main/flashsale.php"); ?>
<?php include("pages/main/banner.php"); ?>
<?php include("pages/main/suggestion.php"); ?>
