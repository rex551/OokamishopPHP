<?php  
    ...
    $query = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tinhtrang=1 AND tbl_sanpham.tensanpham LIKE '%".$_POST["key"]."%' LIMIT $start_from, $record_per_page";  
    ...
    $page_query = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tinhtrang=1 AND tbl_sanpham.tensanpham LIKE '%".$_POST["key"]."%'";  
